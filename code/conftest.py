...
def pytest_configure(config):
    if not hasattr(config, 'workerinput'):
        ...
        app_stderr = open('app_stderr', 'w')
        app_stdout = open('app_stdout', 'w')

        app_proc = subprocess.Popen(['python', app_path],
        ...
        stub_stderr = open('stub_stderr', 'w')
        stub_stdout = open('stub_stdout', 'w')

        stub_proc = subprocess.Popen(['python', stub_path],
...
def pytest_unconfigure(config):
    ...
    config.app_proc.signal.CTRL_C_EVENT(signal.SIGINT)
